...
function upgrade_module_3_0_0($object)
{
    ...
    if (!Db::getInstance()->insert('sofinco_card', $card)) {
        return false;
    }
    ...
    if (version_compare(_PS_VERSION_, '1.5', '>=')) {
        $sql = array();
        $sql[] = 'ALTER TABLE `'._DB_PREFIX_.'sofinco_order` ADD `method` varchar(30) NULL';
        $sql[] = 'ALTER TABLE `'._DB_PREFIX_.'sofinco_order` ADD `carte_num` varchar(30) NULL';
